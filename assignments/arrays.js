...
// the index of id 33 is 32, using Template literals, you're able to include the expression with the string

// ==== Challenge 2 ====
// The dealer needs the information on the last car in their inventory.  What is the make and model of the last car in the inventory?  Log the make and model into the console.
let lastCar = 0;
console.log(`The make is ${inventory[inventory.length-1]["car_make"]} and the model is ${inventory[inventory.length-1]["car_model"]}.`);
